...
class SwitzerlandSpiderSpider(scrapy.Spider):
    name = 'Switzerland_spider'
    allowed_domains = ['ch.bizdirlib.com']
    start_urls = ['https://ch.bizdirlib.com/company?page=14240']
    ...
    def parse(self, response):#获取url
        ...
        for i in range(len(url_list)):
            link = "https://ch.bizdirlib.com"+str(response.xpath('//*[@id="block-system-main"]/div/div/div[2]/div/ul/li['+str(i)+']/div/span/a/@href').extract_first())
        ...
        if next_link:
            next_link = next_link
            yield scrapy.Request("https://ch.bizdirlib.com"+next_link,callback=self.parse)
